...
int main() {
    ...
    for (int platformIndex = 0; platformIndex < platformsCount; ++platformIndex) {
        ...
        for (int deviceIndex = 0; deviceIndex < devicesCount; ++deviceIndex) {
            std::cout << std::endl << "    Device #" << (deviceIndex + 1) << "/" << devicesCount << std::endl;
            ...
            switch (deviceType) {
                ...
                case CL_DEVICE_TYPE_GPU:
                    ...
                    break;
                default:
                    deviceTypeString = "something weird";
            }
            ...
            std::cout << "        Device memory:  " << deviceMemSize / 1000000 << " MB" << std::endl;
            ...
            std::vector<unsigned char> deviceVersion(deviceVendorSize, 0);
